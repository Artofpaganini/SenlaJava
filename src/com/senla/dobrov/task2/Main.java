package com.senla.dobrov.task2;

import com.senla.dobrov.utils.IntegerReader;
import com.senla.dobrov.utils.IntegerUtilities;

/*
Создать программу, которая будет вычислять и выводить на экран НОК (наименьшее общее кратное) и НОД (наибольший общий делитель) двух целых чисел,
